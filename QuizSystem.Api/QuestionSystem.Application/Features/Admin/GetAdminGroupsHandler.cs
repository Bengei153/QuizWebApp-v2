...
public class GetAdminGroupsHandler : IRequestHandler<GetAdminGroupsQuery, List<QuestionGroupListDto>>
{
    private readonly IQuestionGroupRepository _groupRepository;

    public GetAdminGroupsHandler(IQuestionGroupRepository groupRepository)
    {
        _groupRepository = groupRepository;
    }

    public async Task<List<QuestionGroupListDto>> Handle(
        GetAdminGroupsQuery request,
